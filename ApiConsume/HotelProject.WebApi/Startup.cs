...
using HotelProject.DataAccessLayer.EF;
...
namespace HotelProject.WebApi
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<Context>();//eklendi.
            services.AddScoped<IStaffDal, EfStaffDal>(); //IStaffDal ı gördüğünde EfStaffDal'ı kulan
